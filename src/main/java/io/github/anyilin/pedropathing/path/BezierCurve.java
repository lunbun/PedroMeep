...
public class BezierCurve {
     ...
     */
    public BezierCurve(FollowerConstants constants) {
        this.APPROXIMATION_STEPS = constants.APPROXIMATION_STEPS;
    }
     ...
     */
    public BezierCurve(FollowerConstants constants, ArrayList<Point> controlPoints) {
        this.APPROXIMATION_STEPS = constants.APPROXIMATION_STEPS;
     ...
     */
    public BezierCurve(FollowerConstants constants, Point... controlPoints) {
        this.APPROXIMATION_STEPS = constants.APPROXIMATION_STEPS;
