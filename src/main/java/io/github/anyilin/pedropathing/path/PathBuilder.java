package io.github.anyilin.pedropathing.path;
...
public class PathBuilder {
     ...
     */
    public PathBuilder(FollowerConstants constants) {
    ...
    public PathBuilder addPath(BezierCurve curve) {
        this.paths.add(new Path(constants, curve));
        return this;
    }
    ...
    public PathBuilder addBezierCurve(Point... controlPoints) {
        return addPath(new BezierCurve(constants, controlPoints));
    }
    ...
    public PathBuilder addBezierLine(Point startPoint, Point endPoint) {
        return addPath(new BezierLine(constants, startPoint, endPoint));
    }
     ...
     * @return This returns itself with the updated data.
     */
    public PathBuilder addTemporalCallback(double time) {
        this.callbacks.add(new PathCallback(time, PathCallback.TIME, paths.size() - 1));
        return this;
    }
     ...
     * @return This returns itself with the updated data.
     */
    public PathBuilder addParametricCallback(double t) {
        this.callbacks.add(new PathCallback(t, PathCallback.PARAMETRIC, paths.size() - 1));
        return this;
    }
