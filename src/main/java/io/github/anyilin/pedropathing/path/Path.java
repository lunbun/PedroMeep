...
public class Path {
     ...
     */
    public Path(FollowerConstants constants, BezierCurve curve) {
        zeroPowerAccelerationMultiplier = constants.zeroPowerAccelerationMultiplier;
        pathEndVelocityConstraint = constants.pathEndVelocityConstraint;
        pathEndTranslationalConstraint = constants.pathEndTranslationalConstraint;
        pathEndHeadingConstraint = constants.pathEndHeadingConstraint;
        pathEndTValueConstraint = constants.pathEndTValueConstraint;
        pathEndTimeoutConstraint = constants.pathEndTimeoutConstraint;
